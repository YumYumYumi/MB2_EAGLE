...
angiosperms <- sf::st_read("forest1_vec_fixed.shp") # vector of broad-leaved forests
gymnosperms <- sf::st_read("forest2_vec_fixed.shp") # vector of coniferous forests
